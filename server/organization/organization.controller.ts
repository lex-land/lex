...
export class OrganizationController {
  ...
  @Get()
  @Render('views/Organization')
  public async organizationInitialQuery() {
    // res.render('organization/views/Organization',props)
    return {
      organizations: await this.orgService.findAll(),
    };
  }

  @Get('new')
  @Render('views/New')
  public async organizationNewInitialQuery() {
    return {
  ...
  @Post('new')
  @Render('views/New')
  public async create(@Body() body: PostOrgPayload, @Req() req: any) {
    // TODO: 微服务出现不响应的问题
